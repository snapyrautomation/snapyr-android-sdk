...
public class NonImplicitReceiver extends BroadcastReceiver {
    ...
    public NonImplicitReceiver() {
        Log.e("YYY", "NonImplicitReceiver (BROADCAST): CONSTRUCTOR");
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        // an Intent broadcast.
        Log.e("YYY", "BROADCAST RECEIVER NonImplicitReceiver onReceive::: (awaiting debugger connection...");
//        android.os.Debug.waitForDebugger();
        Log.e("YYY", MessageFormat.format(
                "NonImplicitReceiver ONRECEIVE!!! Intent: {0}\nAction: {1}\nCategories: {2}\nData: {3}\nExtras: {4}\n",
